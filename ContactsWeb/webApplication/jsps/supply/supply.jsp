  ...
  <table cellspacing="1" cellpadding="3" align="center">
   <form name="supplyForm" action="<%=request.getContextPath()%>/controller" method="POST">
    ...
    <tr>
     ...
     <td align="left"><input type="text" name="name" class="elem" size="25" value="<jstl:out value="${supply.attributes.name}"/>"></td>
     <td align="right">Группа</td>
     <td align="left"><input type="text" name="parentName" class="elem" size="25" value="<jstl:out value="${supply.attributes.parentName}"/>"></td>
    </tr>
    <tr>
     ...
     <td align="left">
      <select name="kind" class="elem">
       <logic:iterate name="supplyKinds_2" id="kind">
        <option value="<jstl:out value="${kind.id}"/>"<jstl:if test="${supply.attributes.kind == kind.id}"> selected</jstl:if>><jstl:out value="${kind.name}"/></option>
       </logic:iterate>
      </select>
     </td>
     <td></td>
     <td align="left"><input type="checkbox" name="important"<jstl:if test="${supply.attributes.important}"> checked</jstl:if>>Важные данные</td>
    </tr>
    <tr>
     <td align="right">Адрес</td>
     <td align="left"><textarea" name="address" class="elem" rows="5" cols="25" wordwrap="true"><jstl:out value="${supply.attributes.address}"/></textarea></td>
     <td align="right">Доп. инфо</td>
     <td align="left"><textarea" name="note" class="elem" rows="5" cols="25" wordwrap="true"><jstl:out value="${supply.attributes.note}"/></textarea></td>
    </tr>
    <tr>
     <td align="right">Адрес сайта</td>
     <td align="left"><input type="text" name="url" class="elem" size="25" value="<jstl:out value="${supply.attributes.url}"/>"/></td>
     <td align="right">ИНН</td>
     <td align="left"><input type="text" name="inn" class="elem" size="25" value="<jstl:out value="${supply.attributes.inn}"/>"></td>
    </tr>
    <tr>
     <td align="right">Краткое наименование</td>
     <td align="left"><input type="text" name="shortName" class="elem" size="25" value="<jstl:out value="${supply.attributes.shortName}"/>"/></td>
     <td align="right"></td>
     <td align="left"></td>
    </tr>
   </table>
