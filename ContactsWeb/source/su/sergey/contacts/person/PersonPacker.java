...
public final class PersonPacker implements PersonParameters {
	...
	public PersonSearchParameters getSearchParameters() throws InvalidParameterException {
		...
		PersonSearchParameters searchParameters =
			new PersonSearchParameters(firstName, middleName, lastName, phone, yearOfBirthday, monthOfBirthday, email, icq, address, gender, groupMode, note, false);
	...
	private Date getMsuGraduateDate() throws InvalidParameterException {
		...
		try {
			...
			result = (value.length() > 0) ? validator.validateDate(value, YEAR_FORMAT) : null;
		} catch (FieldException e) {
	...
	private Date getYearOfBirthday() throws InvalidParameterException {
		...
		try {
			...
			result = (value != null) ? validator.validateDate(value, YEAR_FORMAT) : null;
		} catch (FieldException e) {
