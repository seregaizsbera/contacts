...
public class SetBasicEmailCommand extends DefaultPersonCommand {
	/**
	...
	public String execute(HttpServletRequest request) throws ContactsException, InvalidParameterException {
		...
		delegate.setBasicPersonEmail(personHandle, emailHandle);
		request.setAttribute(RequestConstants.AN_MESSAGE, "Адрес электронной почты помечен как основной");
