...
/**
 * Диспетчер справочников НСИ - на текущий момент отвечает за показ странички со списком
 * записей справочника для выбора одной из них и возврата полученного значения
 * в форму, вызвавшую страничку со списком записей справочника.
 * 
...
//
//    /**
//     * Обрабатывает показ заданнной страницы со справочниками
//     */
//    private String processPageDirectories(DirectoryHttpServletRequest request) throws SberbankException, ServletException  {
//        IDirectoriesPageIteratorBusinessDelegate iterator =
//                (IDirectoriesPageIteratorBusinessDelegate)request.getSessionPageIterator(SESSION_ITERATOR_DIRECTORIES);
//
