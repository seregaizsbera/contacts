...
/**
* billing/BinaryHelper.java
* Generated by the IDL-to-Java compiler (portable), version "3.0"
* from idl/interface.idl
* 25 Апрель 2004 г. 19:40:17 MSD
*/

abstract public class BinaryHelper
{
  private static String  _id = "IDL:billing/Binary:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (billing.BinaryHelper.id (), "Binary", __typeCode);
    }
    return __typeCode;
  }
