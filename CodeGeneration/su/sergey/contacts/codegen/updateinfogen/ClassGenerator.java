...
public class ClassGenerator extends Broadcaster implements TableListener {
    ...
    public void startTable(Table table) {
        if (Helper.isTarget(table)) {
            ...
            dataClass.append("package ").append(PACKAGE).append(";\n\n").
                    append("public interface ").append(Helper.getUpdateInfoClassName(table)).append(" {\n");
    ...
    public void endTable() {
        if (isTarget) {
            ...
            dataClass.append("}");
            try {
                Writer out = new BufferedWriter(new FileWriter(Environment.DTO_OUT_PUT_PATH + Helper.getUpdateInfoClassName(currentTable) + ".java"));
